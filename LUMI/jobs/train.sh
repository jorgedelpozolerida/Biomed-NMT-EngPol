...
singularity exec -B /scratch/project_465000872 ../envs/test_container_v3.sif python3 ../src/train.py --base_dir /scratch/project_465000872/DATA --config_path ../src/train_config.json --seed 42