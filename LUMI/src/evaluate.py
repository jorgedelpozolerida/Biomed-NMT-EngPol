...
def main(args):
    ...
    test_data_path = os.path.join(tokenizer_folder, args.dataset_name, 'test')
    ...
    model_names = ["facebook/mbart-large-50-one-to-many-mmt"] + os.listdir(models_folder)
    ...
    for model_name in model_names:
            try:
                ...
                translation_results = generate_predictions(args, model, tokenizer, test_data, model_name)
    ...
    save_folder = ensure_dir(os.path.join(save_dir, formatted_time))
